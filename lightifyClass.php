...
//Commands
class osrCommand extends stdClass {
...
//Constants
class osrConstant extends stdClass {
	...
	const METHOD_LOAD_LOCAL      = 1201;
	const METHOD_APPLY_LOCAL     = 1202;
	...
	const LIST_KEY_IDENTS       = "STATE,ONLINE,HUE,COLOR,COLOR_TEMPERATURE,LEVEL,SATURATION,MOTION,SCENE,ZIGBEE,FIRMWARE";
...
class lightifyBase extends stdClass {
	...
	public function getRequestID($uniqueID) {
		$arrayID   = str_split(str_pad(dechex($uniqueID), osrConstant::UUID_DEVICE_LENGTH, 0, STR_PAD_RIGHT), 2);
		$requestID = "";
	...
	public function nameToChr($name) {
		...
		for ($i = 0; $i < osrConstant::DATA_NAME_LENGTH; ++$i) {
