...
class classConstant
{
  ...
  const WRITE_KEY_VALUES   = "ALL_DEVICES,NAME,SAVE,SCENE,SOFT_ON,SOFT_OFF,TRANSITION,RELAX,ACTIVE,PLANT_LIGHT,STATE,COLOR,COLOR_TEMPERATURE,LEVEL,SATURATION";
